...
This module contains the parameters for each data verification test.
Each test is defined as a dictionary.

Each test requires a minimum of four parameters...
