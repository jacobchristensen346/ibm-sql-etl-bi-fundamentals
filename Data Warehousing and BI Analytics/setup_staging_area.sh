# This bash script contains commands used to
# set up a staging database in Postgresql
# Sample billing data is loaded into the database
# dimension and fact tables

# Part of the Hands-on Lab: Verifying Data Quality
