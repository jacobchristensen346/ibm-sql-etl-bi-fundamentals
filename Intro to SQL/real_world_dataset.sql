-- Practice working with a real-world dataset in MySQL
-- chicago_public_schools and chicago_socioeconomic_data tables dumped into MySQL
...
-- In the previous problem we found out that the highest Safety Score is 99, 
-- so we can use that as an input in the where clause:
